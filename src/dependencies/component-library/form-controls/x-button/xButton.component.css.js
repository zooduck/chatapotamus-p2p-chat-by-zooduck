...
/* --------------------------------------------------------------------------------
  The difference between "warning" and "danger" is that "warning" always has a red
  background whereas "danger" has a red background on hover / active / focus only.
   --------------------------------------------------------------------------------
*/
:host([action="warning"]) {
...
/*
  ----------------------------------------------------------
  NECESSARY TO PREVENT OTHER ELEMENTS FROM LOSING FOCUS
  WHEN CLICKING ON THIS ELEMENT WHILE IT IS DISABLED
  AND TO PREVENT SLOTTED CONTENT (OTHER THAN TEXT) FROM
  INTERFERING WITH THE FOCUS PSEUDO-CLASSES OF THE BUTTON.
  ----------------------------------------------------------
*/
.button__label,
