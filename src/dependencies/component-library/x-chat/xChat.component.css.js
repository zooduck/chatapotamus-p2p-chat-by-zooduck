...
| --x-chat-call-to-action-active-brightness        |
| --x-chat-call-to-action-background-color         |
| --x-chat-call-to-action-color                    |
| --x-chat-color                                   |
| --x-chat-message-bubble-background-color         |
| --x-chat-message-bubble-border-color             |
| --x-chat-message-bubble-message-background-color |
| --x-chat-message-bubble-title-color              |
|--------------------------------------------------|
*/
