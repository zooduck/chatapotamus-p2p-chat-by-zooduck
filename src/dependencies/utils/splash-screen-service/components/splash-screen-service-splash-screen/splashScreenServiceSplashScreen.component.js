...
class HTMLSplashScreenServiceSplashScreenElement extends WebComponent {
  ...
  attributeChangedCallback(attributeName, oldValue, newValue) {
    ...
    switch (attributeName) {
      ...
      case 'message':
        this.ready().then(() => {
          this.shadowRoot.getElementById('message').innerText = newValue; // innerText allows newline characters
        });
        break;
      case 'splash-screen-title':
        this.ready().then(() => {
          this.shadowRoot.getElementById('title').innerText = newValue; // innerText allows newline characters
        });
        break;
      default:
        break;
