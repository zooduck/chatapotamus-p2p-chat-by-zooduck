...
| PUBLIC VARIABLES                                                |
|=================================================================|
| --chatapotamus-p2p-chat-by-zooduck-color-scheme-primary-color   |
...
:host {
  ...
  --_breakpoint-mobile: 767px; /* (This value is queried by the component) */
  ...
  /* ----------------------------------- */
  /* PUBLIC COMPONENT VARIABLE OVERRIDES */
  /* ----------------------------------- */
