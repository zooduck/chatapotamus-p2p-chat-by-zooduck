...
:host {
  ...
  --_scrollbar-background-image: url('modules/@zooduck/chatapotamus-p2p-chat-by-zooduck/assets/svg/misc/backdrop_circle_dark.svg');
...
:host([theme="dark"]) :is(.scrollbar-x, .scrollbar-y) {
  --_scrollbar-background-image: url('modules/@zooduck/chatapotamus-p2p-chat-by-zooduck/assets/svg/misc/backdrop_circle_light.svg');
}
